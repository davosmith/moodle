...
$string['upgradeoutputversions'] = 'Output version numbers during upgrades';
$string['upgradeoutputversions_desc'] = 'Output the version number of each element as savepoints are reached, during the web-based upgrade process. This can be helpful in tracking the progress of a major upgrade. This is enabled by default in CLI upgrades (but can be disabled via parameters).';
