...
$string['addcleanresubmission'] = 'Start a new submission';
$string['addcopyresubmission'] = 'Start a new submission based on my previous attempt';
...
$string['atmaxresubmission'] = 'No more resubmissions are allowed';
$string['availability'] = 'Availability';
$string['backtoassignment'] = 'Back to assignment';
$string['batchoperationsdescription'] = 'With selected...';
$string['batchoperationconfirmaddresubmission'] = 'Allow resubmissions for all selected submissions?';
...
$string['batchoperationconfirmremoveresubmission'] = 'Prevent resubmissions for all selected submissions?';
...
$string['previousfeedbackwarning'] = 'You are editing the feedback for a previous submission - {$a->submissionnum} out of {$a->maxsubmissionnum}';
...
$string['removeresubmission'] = 'Prevent resubmission';
$string['removeresubmissionforstudent'] = 'Prevent resubmission for {$a->fullname} ($a->id)';
$string['resubmission'] = 'Resubmission';
$string['resubmission_help'] = 'This controls when resubmissions are opened up to students. <ul><li>Yes - the teacher can choose whether or not resubmissions are added</li><li>Until grade-to-pass is met - resubmission automatically added if the grade is below the grade to pass value in the gradebook.</li></ul>';
$string['resubmissioncount'] = 'Max resubmissions';
$string['resubmission_failedgrade'] = 'Until grade-to-pass is met';
$string['resubmission_manual'] = 'Yes';
$string['resubmission_none'] = 'No';
$string['resubmissionheader'] = 'Resubmission settings';
$string['resubmissiononfailedgrade'] = 'Automatically added if the grade is below {$a}';
$string['resubmissionongrade'] = 'Automatically added when graded';
...
$string['submissionnum'] = 'Submission {$a}';
...
$string['submissionstatus_resub'] = 'Ready for resubmission';
