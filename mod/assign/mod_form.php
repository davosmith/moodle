...
class mod_assign_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'resubmissionheader', get_string('resubmissionheader', 'mod_assign'));
        $options = array(
        ...
        $options = array(assign::MAX_RESUBMISSION_UNLIMITED => get_string('unlimited', 'mod_assign'))
