...
Feature: The my overview block allows users to filter courses by custom fields
  ...
  Scenario: Filter courses by checkbox: Yes
  ...
  Scenario: Filter courses by checkbox: No
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1             | block_myoverview |
      | customfiltergrouping       | checkboxfield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by date: 1 February 2001
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
  ...
  Scenario: Filter courses by date: 6 August 1980
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
      | customfiltergrouping       | datefield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by date: No Date field
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
      | customfiltergrouping       | datefield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by select: Option 1
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_myoverview |
  ...
  Scenario: Filter courses by select: Option 2
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_myoverview |
      | customfiltergrouping       | selectfield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by select: No Select field
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_myoverview |
      | customfiltergrouping       | selectfield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by text: fish
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
  ...
  Scenario: Filter courses by text: dog
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
      | customfiltergrouping       | textfield | block_myoverview |
    And I log in as "student1"
  ...
  Scenario: Filter courses by text: No Text field
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview |
      | customfiltergrouping       | textfield | block_myoverview |
    And I log in as "student1"
